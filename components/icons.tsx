...
export function ChevronRightIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l12 7-12 7" />
    </svg>
  )
}
  ...
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M5 3h14a1 1 0 011 1v2a7 7 0 01-7 7 7 7 0 01-7-7V4a1 1 0 011-1zm7 14v4m-4 0h8"
      />
    </svg>
  )
}
  ...
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M5 21l3-3m0 0l2-8 4-2 2-4h3l-1 4-3 2-1 4 3 4m-9 0l5-3m-5 3v3"
      />
    </svg>
  )
}
  ...
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M5 21c.5-4.5 2.5-8 7-10m4-4c-1.5 1.5-3 4-3.5 6.5M12 7c4-2 8-2 9-1-1 4-2 7-5.5 10.5M7 21c-3-3-3-7 0-10 3-3 7-3 10 0"
      />
    </svg>
  )
}
  ...
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13m0-13C10.832 18.477 9.246 18 7.5 18s4.168-.477 3-1.253m0 13C13.168 18.477 14.754 18 16.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5s3.332.477 4.5 1.253"
      />
    </svg>
  )
}
